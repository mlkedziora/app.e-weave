...
export default function MaterialSelector({ materials, selected, onSelect }: Props) {
  ...
  return (
    <div className="w-full flex flex-col overflow-hidden">
      {/* Full-width header that ignores parent padding (like your form tabs) */}
      <div className="-mx-4 border-b border-gray-300 shrink-0" ref={headerRef}>
      ...
      <SelectableMaterialList materials={filtered} selected={selected} onSelect={onSelect} className="flex-1 pt-4" />
    </div>
  )
}
