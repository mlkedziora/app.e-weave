...
export default function ProjectMaterialCategory({ materials, onExpand, onAdd }: Props) {
  ...
  const TAB_MIN_WIDTH_VW = 15; // Adjust this const to set the minimum width of each category tab as a percentage of viewport width (e.g., 15 for narrower, 25 for wider) to make it responsive to screen size.
  ...
  return (
    <div className={MATERIALS_GAP_CLASS}>
      <div className="-mx-6">
        <div className="border-b border-gray-300 shrink-0" ref={headerRef}>
      ...
      <ProjectMaterialList materials={visibleMaterials} />
