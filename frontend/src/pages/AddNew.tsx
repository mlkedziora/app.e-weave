...
export default function AddNew() {
  return (
    <div className="w-full h-full p-6 overflow-hidden"> {/* Added p-6 for spacing around the card (left from sidebar, bottom from page edge, etc.); overflow-hidden to contain any potential overflow, with scrolling handled inside AddNewTabs */}
